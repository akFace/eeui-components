...
<template>
    <div class="wrapper">
        <div class="g-cover" ref="wxc-cover" v-if="show" @click="hideAction" :style="coverStyle"></div>
        <div ref="wxc-popover" class="g-popover" v-if="show && buttons.length" :style="contentStyle">
            <div class="u-popover-arrow" :style="arrowStyle" v-if="hasArrow"></div>
            <div class="u-popover-inner">
                <div :class="['i-btn',i === buttons.length-1 || !hasBorderBottom ? 'i-btn-noborder' : '']" v-for="(item,i) in buttons" :key="i" @click="wxcButtonClicked(i,item.key)">
    ...
    methods: {
        ...
        wxcPopoverAnimationShow() {
            ...
            animation.transition(popoverEl, {
                ...
                delay: 0,
                duration: 250,
                timingFunction: this.animation.timingFunction || 'ease-out'
            }, (e) => {
                a1End = true;
                if (a1End && a2End) {
